...
2.  **Checkpoints:** Claude takes snapshots of your files automatically before editing them. If a fork goes wrong, a simple _undo_ instantly reverts the file system; having more failed forks doesn't mean leaving garbage in the project.
